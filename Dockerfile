...
# --ignore-scripts: the package's postinstall (scripts/postinstall.ts, added
# ~v0.45) runs `gbrain apply-migrations` for interactive installs — meaningless
# and unavailable in the builder stage (scripts/ isn't copied yet, no DB here).
