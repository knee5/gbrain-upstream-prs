...
description: "Read long material for decision value rather than completeness: decide depth up front, extract only what changes an action, and record what you deliberately skipped"
triggers:
  - "strategic reading"
  - "read long material for decision value rather than completeness"
  - "decide depth up front"
  - "extract only what changes an action"
  - "and record what you deliberately skipped"
---
