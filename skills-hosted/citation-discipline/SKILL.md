...
description: "Audit and fix citation formatting so every factual claim carries an inline source. Use when reviewing a document for unsourced assertions or broken references"
triggers:
  - "citation discipline"
  - "reviewing a document for unsourced assertions"
  - "broken references"
---
...
> not composed by LLM). See _output-rules.md.
