---
name: idea-lineage
description: "Trace where an idea came from and how it changed: link a claim back to its origin, record who influenced it, and detect when an idea has quietly drifted from its source"
triggers:
  - "idea lineage"
  - "trace where an idea came from and how it changed"
  - "link a claim back to its origin"
  - "record who influenced it"
  - "and detect when an idea has quietly drifted from its source"
---
