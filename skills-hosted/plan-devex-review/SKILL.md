...
description: "Audit the developer experience of a tool, API, or SDK: personas, time-to-hello-world, the seven DX characteristics, and a 0-10 scoring rubric"
triggers:
  - "plan devex review"
  - "audit the developer experience of a tool, api, or sdk"
  - "personas"
  - "time-to-hello-world"
  - "the seven dx characteristics"
  - "and a 0-10 scoring rubric"
---
...
\`your skills folder/gstack/plan-devex-review/dx-hall-of-fame.md\`
...
a multiple-choice question to the user:
...
Then SHOW it to the user via a multiple-choice question to the user:
...
Load the "## Pass 1" section from `your skills folder/gstack/plan-devex-review/dx-hall-of-fame.md`
...
3. **a multiple-choice question to the user per friction point.** One question per friction point found.
...
7. a multiple-choice question to the user if there's a genuine DX choice to resolve
...
- **DX EXPANSION:** After fixing to 10, also ask "What would make this dimension
  ...
  individual opt-in multiple-choice questions to the user.
...
> **STOP.** Before running the 8 DX passes, required outputs, and review report (only after Step 0 investigation is complete), Read `your skills folder/gstack/plan-devex-review/sections/review-sections.md` and execute it
