---
name: regex-discipline
description: "Write and review regular expressions safely: test against real data first, avoid catastrophic backtracking, and prefer a parser when the input is structured. Use before applying a regex at scale"
triggers:
  - "regex discipline"
  - "applying a regex at scale"
  - "write and review regular expressions safely"
  - "test against real data first"
  - "avoid catastrophic backtracking"
  - "and prefer a parser when the input is structured"
---
...
## Where This Bites in the knowledge base
