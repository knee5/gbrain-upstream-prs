---
name: data-research
description: "Turn unstructured sources into a maintained structured tracker: search, extract fields, archive the raw source, deduplicate against what you already have"
triggers:
  - "data research"
  - "turn unstructured sources into a maintained structured tracker"
  - "extract fields"
  - "archive the raw source"
  - "deduplicate against what you already have"
---
...
Recipes are YAML files at `your knowledge base{name}.yaml`. Scaffold a new one by
...
Three example recipes ship with the knowledge base (see `your knowledge base`):
