---
name: calibration
description: "State confidence honestly: separate what you verified from what you inferred, avoid false precision, and say plainly when you do not know. Use in any report, review, or research answer"
triggers:
  - "calibration"
...
- `calibration_freshness` — warns when the active profile is older than
  7 days. Hint: `the knowledge base calibration --regenerate`.
