...
import A_0_assets_index_DKN2Tyhc_js from '../admin/dist/assets/index-DKN2Tyhc.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-DKN2Tyhc.js": { path: A_0_assets_index_DKN2Tyhc_js as unknown as string, mime: "application/javascript; charset=utf-8" },
